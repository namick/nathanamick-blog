...
import systemMap from './images/a-living-curriculum-system.svg'
import handoutAnatomy from './images/a-living-curriculum-handout.svg'
import precedenceLadder from './images/a-living-curriculum-precedence.svg'
import theLoop from './images/a-living-curriculum-loop.svg'
...
<Image src={systemMap} alt="The system: research and document standards feed a constitution; instructor-owned steering files feed two skills that read and write the state files; the output is printed pages on her desk" />
...
I cranked Claude Fable up to max and asked it whether or not it minded doing a little bit of research for me - if it wasn't too busy. (I'm kidding. Mechanistic computers don't have feelings.)  This first run was aimed at my immediate needs. I told it I'd be teaching an eighth grader, and gave it the goals of the project, the school calendar, and some of her actual writing. It came back with <a href="/a-living-curriculum/teaching-writing-research.html" target="_blank" rel="noopener noreferrer">a practical brief</a>: what the research says about teaching adolescent writers, whether any existing curriculum was worth buying, what her first two pieces showed, and a sketch of a year.

Two days later, in a completely different session with no memory of the first, I ran it again - this time fully generalized. No eighth grader, no calendar, no goals: just <a href="/a-living-curriculum/teaching-writing-research-2.html" target="_blank" rel="noopener noreferrer">a deep dive on the evidence for teaching writing to adolescents</a>. I wanted real research, learned wisdom, and sources. That run came back with about forty-five primary sources, an effect size for every practice it ranked, and each claim tagged by the kind of evidence behind it - meta-analysis, single experiment, federal practice guide, practitioner wisdom.
...
Then, in a fresh session, I had my handy military-grade intelligence read the research and the calendar and write <a href="/a-living-curriculum/writing-course-plan.html" target="_blank" rel="noopener noreferrer">the course plan</a>. This is the document I'd point to if you asked "so what's the curriculum?" - but it deliberately contains **no pre-written lessons**. From its own opening:
...
- **A weekly rhythm** that never changes: a daily freewrite, a daily sentence drill, 40–60 minutes of daily drafting, a couple of sessions a week where we write *together*, a weekly conference about the piece in flight, and most Fridays something *ships* - finished and shared, framed as a celebration, never a deadline.
...
One thing in there runs on a slower clock than everything else. Techniques turn over lesson to lesson - dialogue punctuation Monday, sentence openers Thursday - but a *strategy*, meaning the named and reusable procedure for planning or revising a whole piece, gets one per quarter and is taught the way the research says to teach it: talk it through, model it aloud, she memorizes it, she uses it with help, she uses it alone. What decides when it's learned is not the calendar. It's whether she reaches for it unprompted on a piece nobody told her to plan.

It's a living document in the literal sense: it has a version number and a change log, and it's already at v1.3 in the first week. That last revision came from the research itself. The deep evidence review was finished after the plan was written, so re-reading the two against each other turned up four things the plan had missed - the quarterly strategy above among them. The plan serves the writer, not the other way around.
...
<Image src={handoutAnatomy} alt="Anatomy of a daily handout: the technique named in plain words, a warm-up drill from her own sentences, a freewrite, a mini-lesson with a mentor text, one labeled writing assignment with countable requirements, a self-checkable checklist that later becomes the evaluation rubric, a stretch, and a cut-out pocket card" />
...
That note is a record, though, not a replacement. The plan puts the conversation first: most weeks we sit down with the finished piece and *she* talks first - what she was going for, where it fought her - and I answer as a reader before anything gets written down. The skill writes up what was said. It doesn't stand in for saying it.
...
<Image src={precedenceLadder} alt="The precedence ladder: the course plan (pedagogy) beats GUIDANCE.md (voice) beats the skeletons and print standard (structure) beats the skills' SKILL.md files (procedure) — and above everything, enthusiasm wins" />
...
<Image src={theLoop} alt="The loop: /lessons writes a handout aimed at the tracker, it's printed, the student writes, work lands in completed/, /evaluate checks it against its own lesson's checklist, feedback and seeds update the state files, and the next lesson aims at what her writing just showed" />
...
Her own writing travels the other direction. She drafts in a Google Doc and sends it over when she's finished, and I print that - so the piece she just wrote exists in her hands as a real object, not only as a file in a folder.
...
There's one more thing only the human side can do, and the plan now says it out loud: the mini-lesson is a demonstration, not a reading. Before she tries the technique, I try it in front of her - thinking out loud, false starts and crossed-out verbs included. The messy middle *is* the lesson, and it's the part a classroom of thirty can almost never afford. Some days I just write alongside her, my own project, my own struggle visible.
