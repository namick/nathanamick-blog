...
summary: A look at the shift from a separation of concerns based on technology (HTML, CSS, JavaScript) to one based on UI objects (like buttons, navigation bars, cards).
